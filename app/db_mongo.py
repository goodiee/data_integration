...
def ensure_indexes():
    # unique natural key per datapoint
...
def get_annotations(country: str, metric: str, start: str, end: str) -> List[Dict[str, Any]]:
    """Return docs for country/metric with date in [start, end]."""
...
def upsert_comment(country: str, date_str: str, metric: str, user: str, comment: str, value=None):
    """
    ...
    # set value/created_at only on first insert for this (country,date,metric)
